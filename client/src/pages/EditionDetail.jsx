...
function BannerSlider({ images, year }) {
  ...
  if (images.length === 0) {
    return (
      <div className="relative w-full h-[250px] sm:h-[400px] md:h-[500px] mb-12 rounded-[2rem] overflow-hidden bg-slate-900/40 backdrop-blur-xl border border-white/10 flex flex-col items-center justify-center text-center p-6 shadow-2xl">
        ...
        {images.map((_, i) => (
          <button
            ...
            className={`h-1.5 sm:h-2 rounded-full transition-all duration-500 ${curr === i
              ? "bg-[#d4af37] w-8 sm:w-12 shadow-[0_0_10px_#d4af37]"
...
export default function EditionDetail() {
  ...
  if (!edition && !isCovidYear) {
    return (
      <div className="min-h-screen bg-[#020617] text-white flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="text-center relative z-10 bg-slate-900/40 backdrop-blur-xl border border-white/10 p-10 sm:p-16 rounded-[2rem] shadow-2xl">
          <h1 className="text-4xl sm:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 mb-4">Edition Not Found</h1>
          <p className="text-slate-400 mb-10 text-lg">We couldn't find the information for the edition: <strong className="text-white">{identifier}</strong>.</p>
          <Link
            to="/previous-editions"
            onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); }}
            className="inline-flex items-center gap-2 bg-gradient-to-r from-[#d4af37] to-[#b2994c] text-black px-8 py-4 rounded-full font-bold hover:scale-105 hover:shadow-[0_10px_30px_rgba(212,175,55,0.3)] transition-all duration-300"
          >
            Browse All Editions
          </Link>
        </div>
  ...
  return (
    <section className="bg-[#020617] text-white min-h-screen pt-24 sm:pt-32 pb-16 px-4 sm:px-8 md:px-12 lg:px-16 overflow-x-hidden relative">
      {/* Premium Background Effects */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-0 right-1/4 w-[400px] h-[400px] bg-gradient-to-br from-[#d4af37]/5 to-transparent rounded-full blur-[80px] animate-pulse"></div>
        <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-blue-600/5 rounded-full blur-[100px] animate-pulse delay-1000"></div>
      </div>

      <div className="max-w-7xl mx-auto relative z-10">

        {!edition && isCovidYear ? (
          <div className="relative w-full py-20 px-6 sm:px-12 mb-12 sm:mb-16 rounded-[2rem] sm:rounded-[3rem] overflow-hidden bg-slate-900/40 backdrop-blur-xl border border-white/10 flex flex-col items-center justify-center text-center shadow-[0_20px_50px_rgba(0,0,0,0.5)] group">
        ...
        <div className="space-y-16 sm:space-y-24 mt-16 sm:mt-24">
          ...
          <header className="max-w-5xl text-center mx-auto">
            ...
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-8 leading-[1.15] tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ffeec3] via-[#d4af37] to-[#b2994c] drop-shadow-[0_2px_15px_rgba(212,175,55,0.3)]"> Healthcare Awards {displayYear}</span>
            </h1>
          ...
          {edition && (
            <div className="grid lg:grid-cols-12 gap-10 sm:gap-12 items-stretch">
              ...
              <section className="lg:col-span-5 flex">
                <div className="w-full bg-slate-900/50 p-8 sm:p-12 rounded-[2rem] sm:rounded-[3rem] border border-white/10 backdrop-blur-xl relative overflow-hidden group hover:border-[#d4af37]/30 transition-all duration-500 shadow-2xl flex flex-col justify-center">
              ...
              <section className="lg:col-span-7 grid grid-cols-2 gap-4 sm:gap-6">
                {[
                  ...
                  <div key={i} className="bg-slate-900/30 p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-white/5 flex flex-col justify-center items-center text-center group hover:border-[#d4af37]/30 hover:bg-slate-900/70 transition-all duration-500 relative overflow-hidden backdrop-blur-md">
          ...
          <section className="bg-slate-900/60 p-8 sm:p-14 md:p-16 rounded-[2rem] sm:rounded-[3rem] border border-white/10 shadow-2xl relative overflow-hidden backdrop-blur-xl">
