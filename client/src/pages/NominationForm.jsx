...
export default function NominationForm() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#020617] flex items-center justify-center">
        <FiRefreshCcw className="text-[#34d399] w-12 h-12 animate-spin" />
      </div>
    );
  }
  ...
  return (
    ...
    <div className="max-w-5xl mx-auto px-4 pb-32 pt-10 relative z-10">
      <div className="mt-15 flex justify-between items-center ">
        <button
          onClick={() => isEditMode ? navigate(-1) : navigate("/")}
          className="flex items-center gap-2 text-[#34d399] hover:text-[#10b981] transition-colors font-bold uppercase tracking-widest text-xs"
        >
      ...
      <div className="mb-8 md:mb-10 text-center relative">
        <div className="flex flex-col items-center justify-center mb-6">
          ...
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[9px] sm:text-xs font-bold uppercase tracking-[0.2em] bg-[#34d399]/10 border border-[#34d399]/35 text-[#6ee7b7] mb-4 shadow-[0_0_15px_rgba(212,175,55,0.15)] animate-pulse">
          ...
          <h1 className="font-heading tracking-tight text-center px-4 max-w-3xl mx-auto flex flex-col gap-1.5">
            ...
            <span className="block text-2xl sm:text-3xl md:text-[40px] font-black uppercase leading-none tracking-tighter">
              <span className="text-gradient-emerald drop-shadow-[0_2px_8px_rgba(212,175,55,0.4)]">
                International
              </span>{" "}
            ...
            <span className="block text-lg sm:text-xl md:text-[24px] font-extrabold uppercase leading-tight tracking-tight mt-0.5">
              <span className="text-gradient-emerald drop-shadow-[0_2px_8px_rgba(212,175,55,0.3)]">
                Excellence Awards
              </span>{" "}
              ...
              {[
                ...
                <label
                  ...
                  className={`group relative flex flex-col items-center justify-center p-4 sm:p-8 rounded-xl sm:rounded-3xl border-2 cursor-pointer transition-all duration-500 overflow-hidden
                      ...
                      ? type.primary
                        ? "bg-gradient-to-br from-[#34d399] via-[#10b981] to-[#047857] border-transparent text-black scale-[1.05] shadow-[0_20px_40px_rgba(212,175,55,0.4)] ring-4 ring-[#34d399]/20"
                      ...
                      : "bg-white/5 border-white/10 text-gray-400 hover:bg-white/10 hover:border-[#34d399]/40 hover:scale-[1.02] shadow-xl"
                    }`}
                >
                  <input
                    type="radio"
                  ...
                  <div className="relative z-10 flex flex-col items-center text-center">
                    ...
                    <span className={`text-sm sm:text-2xl font-black uppercase tracking-tighter leading-none transition-all duration-300 ${form.participationType === type.id ? "scale-110" : "text-[#34d399] drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]"}`}>
                      {type.highlight}
                    </span>
                  </div>
              ...
              <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 p-4 sm:p-6 rounded-2xl bg-white/5 border border-white/5">
                <div className="sm:col-span-2 mb-2">
                  <h3 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                    <span className="h-2 w-2 rounded-full bg-[#34d399]"></span> Category
                  </h3>
                </div>
            ...
            <>
              <div className="md:col-span-2 p-5 sm:p-8 rounded-3xl bg-gradient-to-br from-white/5 to-transparent border border-white/10 flex flex-col items-center">
                ...
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-8">
                  ...
                  <div>
                    <label className="block text-[10px] font-black text-[#34d399] uppercase tracking-[0.2em] mb-3 ml-1">Annual Turnover</label>
